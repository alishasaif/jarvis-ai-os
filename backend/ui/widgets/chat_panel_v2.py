...
class ChatPanelV2(QWidget):
    ...
    def __init__(self):
        ...
        self.send.clicked.connect(self.ask_ai)
        self.input.returnPressed.connect(self.ask_ai)

        self.jarvis_message("J.A.R.V.I.S ONLINE")
        self.jarvis_message("Awaiting your command.")
    ...
    def ask_ai(self):
        ...
        try:
            ...
            self.jarvis_message(answer)

        except Exception as e:

            self.jarvis_message(f"ERROR : {e}")